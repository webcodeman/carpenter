...
if ( ! class_exists( 'RW_Meta_Box' ) )
{
	...
	class RW_Meta_Box
	{
		...
		function admin_enqueue_scripts()
		{
			...
			wp_enqueue_style( 'liocss', hmk_URI . '/admin/assets/css/admin-style.css', RWMB_VER );
			wp_enqueue_script( 'rwmb-clone', hmk_URI . '/hmk/metaboxes/js/clone.js', RWMB_VER );
			wp_enqueue_script( 'iphone-check', hmk_URI . '/admin/assets/js/iphone-style-checkboxes.js' );
			wp_enqueue_script( 'iphonecheck', hmk_URI . '/hmk/metaboxes/js/iphonecheck.js', RWMB_VER );
			wp_enqueue_script( 'metajs', RWMB_JS_URL . 'metajs.js', RWMB_VER );
