...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'options_frameproject_theme' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'options_frameproject_theme' ),
		'repeat-y'  => __( 'Repeat Vertically', 'options_frameproject_theme' ),
		'repeat'    => __( 'Repeat All', 'options_frameproject_theme' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'options_frameproject_theme' ),
		'top center'    => __( 'Top Center', 'options_frameproject_theme' ),
		'top right'     => __( 'Top Right', 'options_frameproject_theme' ),
		'center left'   => __( 'Middle Left', 'options_frameproject_theme' ),
		'center center' => __( 'Middle Center', 'options_frameproject_theme' ),
		'center right'  => __( 'Middle Right', 'options_frameproject_theme' ),
		'bottom left'   => __( 'Bottom Left', 'options_frameproject_theme' ),
		'bottom center' => __( 'Bottom Center', 'options_frameproject_theme' ),
		'bottom right'  => __( 'Bottom Right', 'options_frameproject_theme')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'options_frameproject_theme' ),
		'fixed'  => __( 'Fixed in Place', 'options_frameproject_theme')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'options_frameproject_theme' ),
		'italic'      => __( 'Italic', 'options_frameproject_theme' ),
		'bold'        => __( 'Bold', 'options_frameproject_theme' ),
		'bold italic' => __( 'Bold Italic', 'options_frameproject_theme' )
	);
