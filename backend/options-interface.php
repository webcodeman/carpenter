...
function optionsframeproject_tabs() {
	$counter = 0;
...
function optionsframeproject_fields() {
	...
	foreach ( $options as $value ) {
		...
		// Uploader
		case "upload":
			$output .= optionsframeproject_uploader( $value['id'], $val, null );
		...
		case 'background':
			...
			$output .= optionsframeproject_uploader( $value['id'], $background['image'], null, esc_attr( $option_name . '[' . $value['id'] . '][image]' ) );
